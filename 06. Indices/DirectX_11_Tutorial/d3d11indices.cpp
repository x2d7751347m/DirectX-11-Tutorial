...
bool InitializeScene()
{
    ...
    Vertex vertices[] =
    {
        { XMFLOAT3(-0.5f, -0.5f, 0.5f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f), XMFLOAT4(0.5f, 0.5f, 0.5f, 1.0f) },
        ...
        { XMFLOAT3(0.5f, -0.5f, 0.5f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f), XMFLOAT4(0.5f, 0.5f, 0.5f, 1.0f) },
    };
...
void DrawScene()
{
    ...
    g_pd3dDeviceContext->DrawIndexed(6, 0, 0);  // 6 indices for a square (2 triangles)
