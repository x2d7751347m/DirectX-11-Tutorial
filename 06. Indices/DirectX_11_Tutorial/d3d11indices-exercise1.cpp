...
// diff
ComPtr<ID3D11Buffer> g_pIndexBuffer1;
ComPtr<ID3D11Buffer> g_pIndexBuffer2;
...
bool InitializeScene()
{
    ...
    D3D11_INPUT_ELEMENT_DESC layout[] =
    {
        ...
        { "COLORTWO", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 28, D3D11_INPUT_PER_VERTEX_DATA, 0 },
    };
    ...
    hr = g_pd3dDevice->CreateBuffer(&bd, &InitData, &g_pIndexBuffer1);
    if (FAILED(hr))
        return false;
...
void DrawScene()
{
    ...
    g_pd3dDeviceContext->IASetIndexBuffer(g_pIndexBuffer1.Get(), DXGI_FORMAT_R32_UINT, 0);
    g_pd3dDeviceContext->DrawIndexed(3, 0, 0);

    // Draw the second triangle
    g_pd3dDeviceContext->IASetIndexBuffer(g_pIndexBuffer2.Get(), DXGI_FORMAT_R32_UINT, 0);
    g_pd3dDeviceContext->DrawIndexed(3, 0, 0);
