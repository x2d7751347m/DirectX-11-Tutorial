...
bool InitializeDirect3D()
{
    ...
    g_pd3dDeviceContext->OMSetDepthStencilState(pDSState.Get(), 1);
...
{ XMFLOAT3(-0.7f, -0.7f, 0.7f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },
{ XMFLOAT3(-0.7f, 0.7f, 0.7f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },
{ XMFLOAT3(0.0f,  0.7f, 0.7f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },
    };

    D3D11_BUFFER_DESC bd = {};
    bd.Usage = D3D11_USAGE_DEFAULT;
    bd.ByteWidth = sizeof(Vertex) * 7;
...
void DrawScene()
{
    ...
    g_pd3dDeviceContext->DrawIndexed(9, 0, 0);  // 6 indices for a square (2 triangles)
